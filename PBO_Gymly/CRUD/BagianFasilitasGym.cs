...
namespace PBO_Gymly.CRUD
{
    internal class BagianFasilitasGym : Database_FasilitasGym
    {
        ...
        public static void UpdateFasilitas(int idFasilitas, Struktur_FasilitasGym fasilitas)
        {
            string query = $"UPDATE {table} SET nama_fasilitas = @nama_fasilitas, jumlah_fasilitas = @jumlah_fasilitas, fasilitas_baik = @fasilitas_baik, fasilitas_rusak = @fasilitas_rusak WHERE id_fasilitas_gym = @id";
        ...
        internal static void UpdateFasilitas(int idFasilitas, string newNamaFasilitas, int newJumlahFasilitas, int newFasilitasBaik, int newFasilitasRusak)
        {
